...
Run after seed.execute():
    bench --site <site> execute knit_demo.demo_seed.flows.run_c2c
    bench --site <site> execute knit_demo.demo_seed.flows.run_p2p
...
def run_p2p():
	...
	require(
		"Item", item_code, "Run knit_demo.demo_seed.operations.seed_production first."
	)
