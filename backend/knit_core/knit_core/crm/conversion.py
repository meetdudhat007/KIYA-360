...
from knit_core.business_status import engine

LEAD = "KNIT Lead"
CUSTOMER = "KNIT Customer"
...
def customer_name_for(lead):
	"""KNIT Customer is autonamed field:customer_name, so this is also its id."""
...
def convert_lead(lead, customer=None):
	...
	customer -- an existing KNIT Customer to link instead of deriving one from
