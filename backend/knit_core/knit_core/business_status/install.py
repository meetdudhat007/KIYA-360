"""Adds the business status field to the doctypes the adapter governs.
    ...
    bench --site <site> execute knit_core.business_status.install.install
"""
...
from knit_core.business_status.engine import FIELD, conflicting_workflow
		...
		doctype: [
			{
				...
				"in_list_view": 1,
				"insert_after": "status",
				"description": "CD-002 operational status. Set only via knit_core.business_status.engine.transition.",
			}
		]
