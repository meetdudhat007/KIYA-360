...
knit360_core.business_status.model and knit360_core.brd_data -- rather
...
from knit360_core.standalone import store

STATIC = Path(__file__).parent / "static"
DEMO_USER = brd_data.BRD_USER_ROLE["user_full_name"]

app = FastAPI(title="KNIT 360 — Business Status Preview")
