"""The KNIT 360 Customer-to-Cash workspace, served at /knit360.
...
session cookie set by the KNIT 360-branded /login, and the CSRF token Frappe
...
goes to knit360_core.api.c2c, never to Frappe's generic /api/resource endpoints.
"""
...
def get_context(context):
	if frappe.session.user == "Guest":
		frappe.local.flags.redirect_location = "/login?redirect-to=/knit360"
