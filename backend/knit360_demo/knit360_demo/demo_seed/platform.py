"""Day 3-4: Sales Order approval workflow and the stand-in dashboard.
    ...
    bench --site <site> execute knit360_demo.demo_seed.platform.install_workflow
    bench --site <site> execute knit360_demo.demo_seed.platform.install_dashboard
...
framework feature, not the approved KNIT 360 lifecycle.
...
from knit360_demo.demo_seed._util import insert_if_absent, require

WORKFLOW_NAME = "KNIT 360 Sales Order Approval"
...
APPROVAL_CONDITION = (
	'doc.grand_total <= frappe.db.get_value("Role", "{role}", "knit360_approval_authority")'
...
CARDS = [
	{
		"name": "KNIT 360 Open Sales Orders",
	...
	{
		"name": "KNIT 360 Pending Leave Requests",
...
DASHBOARD_NAME = "KNIT 360 Overview"
